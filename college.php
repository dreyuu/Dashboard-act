...
$query = "SELECT * FROM students WHERE status = 'College'";
    ...
    <div class="d-flex">
        ...
        <div class="dropdown mb-3">
            ...
            <ul class="dropdown-menu custom-dropdown" id="courseList">
                ...
                <li><a class="dropdown-item" href="#" data-course="BSIT">BSIT</a></li>
                <li><a class="dropdown-item" href="#" data-course="BSHM">BSHM</a></li>
                <li><a class="dropdown-item" href="#" data-course="BSOA">BSOA</a></li>
                <li><a class="dropdown-item" href="#" data-course="BSBA">BSBA</a></li>
            </ul>
        </div>
        <div class="dropdown mb-3">
            ...
            <ul class="dropdown-menu custom-dropdown" id="yearList">
                ...
                <li><a class="dropdown-item" href="#" data-course="1st">1st Year</a></li>
                <li><a class="dropdown-item" href="#" data-course="2nd">2nd Year</a></li>
                <li><a class="dropdown-item" href="#" data-course="3rd">3rd Year</a></li>
                <li><a class="dropdown-item" href="#" data-course="4th">4th Year</a></li>
            </ul>
        </div>
        <div class="dropdown mb-3">
